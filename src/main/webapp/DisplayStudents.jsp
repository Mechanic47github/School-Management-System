...
<html lang="en">
  ...
  <div class="container">
    <a class="navbar-brand  href="#"><img src="img/education.png" height =50px> <b> Display Students</b></a>
...
<div class="col-12">
			...
			<%
				...
				q=em.createQuery("select b from Students b");
				List<Students> sl=q.getResultList();
				%>
			...
			<div class="card-body">
			 <h4 class="card-title">Rollno :<%=s.getRollno()%></h4>
				 <h4 class="card-title">Name: <%=s.getName()%></h4>
				 <h4 class="card-title">Standard :<%=s.getStd()%></h4>
				 
				<a class="btn btn-primary " href="UpdateStudentsDisplay?studentsRollno=<%=s.getRollno()%>">Update</a>
				<a class="btn btn-danger " href="RemoveStudentDisplay?studentRollno=<%= s.getRollno()%>">Delete</a>
				</div>	
