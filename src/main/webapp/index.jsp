...
<div class ="row" ><h1><img src="img/education.png" height =70px>&nbsp;<u>School Management System</u></h1>
</div>
  ...
  <div class="container-forms">
    ...
    <form action="login" method="post">
      <div class="form-item log-in">
        <div class="table">
          <div class="table-cell"> 
           <input name="email" placeholder="Email" type="email" /><input name="pass" placeholder="Password" type="Password" />
           <div  class="btn">
            <button type="submit" style="background-color:#ff73b3;color:white; border-color:#ff73b3;"  >
              Log in
              </button>
            </div>
          </div>
      ...
      <div class="form-item sign-up">
        <div class="table">
          <div class="table-cell">
            <input name="name" placeholder="username" type="text" /><input name="age" placeholder="User Age" type="number" /><input name="number" placeholder="Mobile Number" type="number" /><input name="email" placeholder="Email" type="email" /><input name="pass" placeholder="Password" type="password" />
            <div class="btn">
             <button type="submit" style="background-color:#ff73b3;color:white; border-color:#ff73b3;"  >
              Sign up
            </div>
