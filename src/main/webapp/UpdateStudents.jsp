...
<html lang="en">
  ...
  <div class="container-fluid">
    <a class="navbar-brand  href="#"><img src="img/education.png" height =50px> <b> Update Student</b></a>
 ...
 <form action="updatestudents" method="post">
  <div class="contain1" >
    <label for="exampleInputEmail1" class="form-label"> Student Rollno :</label>
    <input type="number" class="form-control" name="rollno" aria-describedby="emailHelp" placeholder="Enter Rollno of Student">
    <br>
